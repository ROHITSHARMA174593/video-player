...
//         <h1 className="text-[20px] font-bold lg:text-[42px] tracking-tighter lg:font-[400] ">
//           NEW ITEMS{" "}
//           <span className="lg:text-[42px] lg:font-[200] text-[20px] font-[300] ">OF THIS SEASON</span>
//         </h1>

//         {/* Horizontal Scrollable Section for Cards */}
//         <div className="mt-6 hide-scrollbar sm:w-full  sm:absolute max-w-full overflow-x-auto">
  ...
  return (
    <PublicLayout>
      ...
      <div className="main-container w-full  sm:px-2">
        ...
        {/* Horizontal Scrollable Section for Cards */}
        <div className="mt-5 hide-scrollbar w-full ">
          <div className="flex gap-6 md:gap-4 sm:gap-2 w-max">
            {movies.map((movie, index) => (
              <div
                key={index}
                className="w-[30vw] sm:w-[30vw] lg:w-[15.45vw] min-h-[18vh] sm:min-h-[35vh] lg:min-h-[35vh] rounded-lg pb-3 group flex-shrink-0 snap-center"
              >
      ...
      <div className="main-container w-full max-w-[1200px] mx-auto  sm:px-2  sm:mt-4 pb-3">
