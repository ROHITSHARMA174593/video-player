...
//   // for Setting Icons on Video Screen
//   const toggleSettings = () => {
//     setShowSettings((prev) => !prev);
//     setMenuLevel("main");
//   };
//   // for Back Button Icons on Video Screen 
//   const toggleBackButton = () => {
//     setBackButton((prev) => !prev)
//     redirect("/")
//   }
//   const handleQualityChange = (selectedLabel: string) => {
//     if (!hlsRef.current) return;
...
//   return (
//     <div>
//       <div className="relative max-w-4xl mx-auto flex items-start mt-3 justify-center w-full h-screen" onMouseEnter={() => setIsHovered(true)}
//           onMouseLeave={() => {
//             setIsHovered(false);
//             setShowSettings(false);
//             setBackButton(false)
...
//             className="absolute top-[23.3vh] left-40 z-50 p-2 rounded-full bg-transparent bg-opacity-50 hover:bg-opacity-80 text-white cursor-pointer"
//           >
//             <FaArrowLeftLong />
//           </button>
//         )}
